...
<html lang="en">
<head>
<title>About - Kameko Yogyakarta</title>
<meta charset="utf-8">
				...
				<div class="col text-center">
					...
					<div class="col-md-12">
						<div class="row mt-5 ml-3">
							<div class="col-md-8">
				dsadkashdkashdkjashdkashkdhaskdhaskjsdhkashdka
							</div>
						<!-- table right-->
						<div class="col-md-4">
							<h5>Follow Us</h5>
						...
						<?php foreach ( $news as $ber) : ?>
							<div class="row mt-1">
								...
								<div class="col-md-8">
									<h6><a href="<?php echo base_url(); ?>News/detail/<?= $ber['id_berita']; ?>"><?= $ber ['judul_berita']; ?></a>
									</h6>
