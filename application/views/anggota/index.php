...
<html lang="en">
<head>
<title>Member - Kameko Yogyakarta</title>
<meta charset="utf-8">
					...
					<div class="row mt-5 ml-3 mr-3">
						...
						<div class="col-md-3">
							<div class="card-deck mt-5">
							  <div class="card">
							    <a href="<?php echo base_url(); ?>Member/detail/<?= $ang['id_anggota']; ?>"><img class="card-img-top" height="250px" src="<?php echo base_url(); ?>anggota/<?= $ang['gambar']; ?>"></a>
							    <div class="card-body">
							    	<center><strong><p class="card-text" style="color: black;"><?= $ang['nama_anggota']; ?></p></strong></center>
							    </div>
							  </div>
							</div>
						</div>
