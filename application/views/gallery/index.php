			...
			<div class="row ml-3 mr-3">
				...
				<div class="col-md-4">
					<div class="card-deck mt-5">
					  <div class="card">
					  	<a target="_blank" href="<?php echo base_url(); ?>hasil_karya/<?= $kar['foto_karya']; ?>" class="perbesar">
					    <img class="card-img-top" height="250px" src="<?php echo base_url(); ?>hasil_karya/<?= $kar['foto_karya']; ?>">
					</a>
					  </div>
					</div>
				</div>
