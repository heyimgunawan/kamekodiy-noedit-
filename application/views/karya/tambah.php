...
<html lang="en">
<head>
<title>Add Creation - Kameko Yogyakarta</title>
<meta charset="utf-8">
		...
		<div class="container">
			<div class="col-md-6 offset-md-3">
				<div class="card-deck mt-5">
					<div class="card">
					  	<div class="card-body">
					    <form action="<?php echo base_url(); ?>Creation/tambah" method="post" enctype="multipart/form-data">
                    	<input type="hidden" name="id_anggota" value="<?= $anggota['id_anggota'];?>">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nama_karya" id="nama_karya">
							</div>
							<div class="form-group">
							...
							<div class="row">
		                        <div class="col-md-6 offset-md-3">
		                    		<a href="<?php echo base_url(); ?>Creation" class="btn col-md-4 btn-success btn-sm float-left">Cancel</a>
