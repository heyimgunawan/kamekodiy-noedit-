...
<html lang="en">
<head>
<title>Event - Kameko Yogyakarta</title>
<meta charset="utf-8">
		...
		<div class="container mt-5">
			...
			<div class="card">
				...
				<div class="row mt-3 ml-3">
					<div class="col-md-4">
						<div class="card">
							<img class="card-img-top" height="200px" src="<?php echo base_url(); ?>admin/berita/<?= $ber ['gambar']; ?>">
					  	</div>
					</div>
					<div class="col-md-8">
						<h4><a href="<?php echo base_url(); ?>News/detail/<?= $ber['id_berita']; ?>"><?= $ber ['judul_berita']; ?></a></h4>
						<p style="font-size: 12px;"><?= $ber ['tgl_berita']; ?></p>
						<?php
						$string = $ber ['isi_berita'];
						$hasil = character_limiter($string, 250);
						?>
